...
### 7.0.18
```
╭─ pwsh     kubernetes-cluster    master ≡  ?1 ~1   22s 719ms⠀                 default@ap-northeast-2  arn:aws:eks:ap-:eks:ap-northeast-2:143719223348:cluster/sksh-argos-p-eks-ui-01    95    7,17:06 
╰─ vagrant up        
PS>vagrant up
Bringing machine 'k8s-master' up with 'virtualbox' provider...
Bringing machine 'k8s-worker-1' up with 'virtualbox' provider...
...
==> k8s-master: Matching MAC address for NAT networking...
==> k8s-master: Checking if box 'bento/ubuntu-22.04' version '202407.23.0' is up to date...
==> k8s-master: Setting the name of the VM: kubernetes-cluster_k8s-master_1736238822768_86157
==> k8s-master: Clearing any previously set network interfaces...
==> k8s-master: Preparing network interfaces based on configuration...
    k8s-master: Adapter 1: nat
    k8s-master: Adapter 2: intnet
...
==> k8s-master: Running provisioner: shell...
    k8s-master: Running: C:/Users/07456/AppData/Local/Temp/vagrant-shell20250107-29676-l9u3c5.sh
    ...
    k8s-master: Get:5 http://security.ubuntu.com/ubuntu jammy-security/main amd64 Packages [2,034 kB]
    ...
    k8s-master: Get:15 http://us.archive.ubuntu.com/ubuntu jammy-updates/universe Translation-en [288 kB]
    k8s-master: Get:16 http://us.archive.ubuntu.com/ubuntu jammy-updates/multiverse amd64 Packages [44.5 kB]
    k8s-master: Get:17 http://us.archive.ubuntu.com/ubuntu jammy-updates/multiverse Translation-en [11.5 kB]
    k8s-master: Get:18 http://us.archive.ubuntu.com/ubuntu jammy-backports/main amd64 Packages [67.7 kB]
    k8s-master: Get:19 http://us.archive.ubuntu.com/ubuntu jammy-backports/main Translation-en [11.1 kB]
    k8s-master: Get:20 http://us.archive.ubuntu.com/ubuntu jammy-backports/universe amd64 Packages [28.9 kB]
    k8s-master: Get:21 http://us.archive.ubuntu.com/ubuntu jammy-backports/universe Translation-en [16.5 kB]
    k8s-master: Get:22 http://security.ubuntu.com/ubuntu jammy-security/universe Translation-en [204 kB]
    k8s-master: Get:23 http://security.ubuntu.com/ubuntu jammy-security/multiverse amd64 Packages [37.6 kB]
    k8s-master: Get:24 http://security.ubuntu.com/ubuntu jammy-security/multiverse Translation-en [8,260 B]
    k8s-master: Fetched 14.9 MB in 6s (2,378 kB/s)
    k8s-master: Reading package lists...
    k8s-master: Reading package lists...
    k8s-master: Building dependency tree...
    k8s-master: Reading state information...
    k8s-master: software-properties-common is already the newest version (0.99.22.9).
    ...
    k8s-master: 3 upgraded, 1 newly installed, 0 to remove and 74 not upgraded.
    ...
    k8s-master: Fetched 647 kB in 2s (325 kB/s)
(Reading database ... 44902 files and directories currently installed.)
    ...
    k8s-master: 0 upgraded, 13 newly installed, 0 to remove and 74 not upgraded.
    ...
    k8s-master: dpkg-preconfigure: unable to re-open stdin: No such file or directory
    k8s-master: Fetched 1,203 kB in 2s (530 kB/s)
...
(Reading database ... 44915 files and directories currently installed.)
    ...
    k8s-master: 74 upgraded, 4 newly installed, 0 to remove and 0 not upgraded.
    ...
    k8s-master: Get:11 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 libpython3.10 amd64 3.10.12-1~22.04.7 [1,949 
kB]
    k8s-master: Get:12 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 python3.10 amd64 3.10.12-1~22.04.7 [509 kB]
    k8s-master: Get:13 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 libpython3.10-stdlib amd64 3.10.12-1~22.04.7 
[1,850 kB]
    ...
    k8s-master: Get:18 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 libcom-err2 amd64 1.46.5-2ubuntu1.2 [9,304 B]    k8s-master: Get:19 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 libk5crypto3 amd64 1.19.2-2ubuntu0.4 [86.3 kB]
    ...
    k8s-master: Get:25 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 libapparmor1 amd64 3.0.4-2ubuntu2.4 [39.7 kB]    k8s-master: Get:26 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 libglib2.0-data all 2.72.4-0ubuntu2.4 [4,582 
B]
    k8s-master: Get:27 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 libglib2.0-bin amd64 2.72.4-0ubuntu2.4 [80.9 
kB]
    ...
    k8s-master: Get:36 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 ubuntu-advantage-tools all 34~22.04 [10.9 kB]    k8s-master: Get:37 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 xxd amd64 2:8.2.3995-1ubuntu2.21 [52.3 kB]
    ...
    k8s-master: Get:49 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 python3-apport all 2.20.11-0ubuntu82.6 [89.0 
kB]
    ...
    k8s-master: Get:64 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 linux-modules-extra-5.15.0-130-generic amd64 
5.15.0-130.140 [63.9 MB]
    ...
    k8s-master: Get:72 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 python3-configobj all 5.0.6-5ubuntu0.1 [34.9 
kB]
    k8s-master: Get:73 http://us.archive.ubuntu.com/ubuntu jammy/main amd64 python3-packaging all 21.3-1 [30.7 kB]
    k8s-master: Get:74 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 python3-twisted all 22.1.0-2ubuntu2.6 [2,007 
kB]
    ...
    k8s-master: Get:78 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 cloud-init all 24.4-0ubuntu1~22.04.1 [565 kB]    k8s-master: dpkg-preconfigure: unable to re-open stdin: No such file or directory
    k8s-master: Fetched 481 MB in 22s (22.2 MB/s)
...
(Reading database ... 45178 files and directories currently installed.)
    ...
    k8s-master: find: ‘/var/tmp/mkinitramfs_BEj2dG/lib/firmware’: No such file or directory
    ...
    k8s-master: update-initramfs: Generating /boot/initrd.img-5.15.0-116-generic
    k8s-master: find: ‘/var/tmp/mkinitramfs_55Hkb6/lib/firmware’: No such file or directory
    k8s-master: Processing triggers for libc-bin (2.35-0ubuntu3.8) ...
    ...
    k8s-master: find: ‘/var/tmp/mkinitramfs_WqUfNX/lib/firmware’: No such file or directory
    ...
    k8s-master: Processing triggers for initramfs-tools (0.140ubuntu13.4) ...
    k8s-master: update-initramfs: Generating /boot/initrd.img-5.15.0-130-generic
    k8s-master: find: ‘/var/tmp/mkinitramfs_sVWi62/lib/firmware’: No such file or directory
    k8s-master: 
...
==> k8s-master: Running provisioner: shell...
    k8s-master: Running: C:/Users/07456/AppData/Local/Temp/vagrant-shell20250107-29676-x5q1ql.sh
    k8s-master: Reading package lists...
    k8s-master: Building dependency tree...
    k8s-master: Reading state information...
    ...
    k8s-master: The following NEW packages will be installed:
    k8s-master:   gnupg-agent
    k8s-master: 0 upgraded, 1 newly installed, 0 to remove and 0 not upgraded.
    k8s-master: Need to get 5,484 B of archives.
    k8s-master: After this operation, 47.1 kB of additional disk space will be used.
    k8s-master: Get:1 http://us.archive.ubuntu.com/ubuntu jammy-updates/universe amd64 gnupg-agent all 2.2.27-3ubuntu2.1 [5,484 B]
    k8s-master: dpkg-preconfigure: unable to re-open stdin: No such file or directory
    k8s-master: Fetched 5,484 B in 0s (12.6 kB/s)
    k8s-master: Selecting previously unselected package gnupg-agent.
(Reading database ... 52603 files and directories currently installed.)
    k8s-master: Preparing to unpack .../gnupg-agent_2.2.27-3ubuntu2.1_all.deb ...
    k8s-master: Unpacking gnupg-agent (2.2.27-3ubuntu2.1) ...
    k8s-master: Setting up gnupg-agent (2.2.27-3ubuntu2.1) ...
    k8s-master: 
    k8s-master: Pending kernel upgrade!
    k8s-master:
    k8s-master: Running kernel version:
    ...
    k8s-master: * Applying /usr/lib/sysctl.d/50-pid-max.conf ...
    k8s-master: kernel.pid_max = 4194304
    k8s-master: * Applying /etc/sysctl.d/99-kubernetes-cri.conf ...
    k8s-master: net.bridge.bridge-nf-call-iptables = 1
    k8s-master: net.ipv4.ip_forward = 1
    k8s-master: net.bridge.bridge-nf-call-ip6tables = 1
    k8s-master: * Applying /usr/lib/sysctl.d/99-protect-links.conf ...
    ...
    k8s-master: Do you want to continue? [Y/n] Abort.
    k8s-master: /tmp/vagrant-shell: line 28: containerd: command not found
    k8s-master: Failed to restart containerd.service: Unit containerd.service not found.
    k8s-master: Failed to start containerd.service: Unit containerd.service not found.
    k8s-master: Failed to enable unit: Unit file containerd.service does not exist.
    k8s-master: containerd set on hold.
==> k8s-master: Running provisioner: shell...
    k8s-master: Running: C:/Users/07456/AppData/Local/Temp/vagrant-shell20250107-29676-hh82jc.sh
    k8s-master: Reading package lists...
    k8s-master: Building dependency tree...
    k8s-master: Reading state information...
    k8s-master: jq is already the newest version (1.6-2.1ubuntu3).
    k8s-master: curl is already the newest version (7.81.0-1ubuntu1.20).
    k8s-master: tmux is already the newest version (3.2a-4ubuntu0.2).
    k8s-master: apt-transport-https is already the newest version (2.4.13).
    k8s-master: 0 upgraded, 0 newly installed, 0 to remove and 0 not upgraded.
    k8s-master: deb [signed-by=/usr/share/keyrings/kubernetes-archive-keyring.gpg] https://apt.kubernetes.io/ kubernetes-xenial main
    k8s-master: Hit:2 http://us.archive.ubuntu.com/ubuntu jammy InRelease
    k8s-master: Ign:1 https://packages.cloud.google.com/apt kubernetes-xenial InRelease
    k8s-master: Hit:3 http://security.ubuntu.com/ubuntu jammy-security InRelease
    k8s-master: Hit:4 http://us.archive.ubuntu.com/ubuntu jammy-updates InRelease
    k8s-master: Err:5 https://packages.cloud.google.com/apt kubernetes-xenial Release
    k8s-master:   404  Not Found [IP: 172.217.25.174 443]
...
==> k8s-master: Running provisioner: shell...
    k8s-master: Running: C:/Users/07456/AppData/Local/Temp/vagrant-shell20250107-29676-8mu53x.sh
    k8s-master: Reading package lists...
    k8s-master: Building dependency tree...
    k8s-master: Reading state information...
    k8s-master: 0 upgraded, 0 newly installed, 0 to remove and 0 not upgraded.
    ...
    k8s-master: Get:1 http://us.archive.ubuntu.com/ubuntu jammy-updates/main amd64 linux-image-unsigned-5.15.0-130-generic amd64 
5.15.0-130.140 [11.8 MB]
    k8s-master: dpkg-preconfigure: unable to re-open stdin: No such file or directory
    k8s-master: Fetched 11.8 MB in 3s (4,094 kB/s)
(Reading database ... 52607 files and directories currently installed.)
...
(Reading database ... 46693 files and directories currently installed.)
    ...
    k8s-master: I: /boot/vmlinuz is now a symlink to vmlinuz-5.15.0-130-generic
    k8s-master: I: /boot/initrd.img is now a symlink to initrd.img-5.15.0-130-generic
(Reading database ... 46696 files and directories currently installed.)
    ...
    k8s-master:
    k8s-master: No VM guests are running outdated hypervisor (qemu) binaries on this host.
    k8s-master: Vacuuming done, freed 0B of archived journals from /var/log/journal/bb2d3e90bb55457a89956d3caec7152d.
...
==> k8s-master: Running provisioner: shell...
    k8s-master: Running: C:/Users/07456/AppData/Local/Temp/vagrant-shell20250107-29676-caska2.sh
    k8s-master: /tmp/vagrant-shell: line 10: kubeadm: command not found
The SSH command responded with a non-zero exit status. Vagrant
assumes that this means the command failed. The output for this command
should be in the log above. Please read the output to determine what
went wrong.
╭─ pwsh     kubernetes-cluster    master ≡  ?7 ~4 -1   8m 2s 512ms⠀ default@ap-northeast-2  arn:aws:eks:ap-northeast-2:143719223348:cluster/sksh-argos-p-eks-ui-01    100    7,17:41 
╰─
```